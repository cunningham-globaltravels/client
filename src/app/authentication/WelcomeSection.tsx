  ...
  return (
    <div className='flex flex-col items-center gap-4 w-full'>
      ...
      <div className='flex flex-col gap-0 mb-2'>
        <Link href={'/'}>
          <h3 className='text-center text-[#B02D1C] font-bold text-2xl md:text-[2rem] leading-9 -tracking-1'>
      ...
      <Image src={'/images/main/welcome_onboard.png'} alt='Welcome Onboard' width={325.5} height={305} />
    </div>
  );
};
