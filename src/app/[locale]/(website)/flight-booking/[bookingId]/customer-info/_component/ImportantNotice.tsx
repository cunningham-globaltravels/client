          ...
          <AccordionItem value='notice'>
            <AccordionTrigger className='px-6 py-4'>
              <div className='flex items-start justify-baseline gap-3'>
                ...
                <h1 className='mt-0.5 font-bold text-2xl leading-6 text-gray-800'>Important Information</h1>
              </div>
            </AccordionTrigger>
            <AccordionContent>
              <CardContent className='mt-2 space-y-4'>
                <h2 className='font-semibold text-orange-700 text-base leading-5'>NOTICE</h2>
                <p className='font-medium text-gray-600 text-base leading-5 max-w-xl'>
