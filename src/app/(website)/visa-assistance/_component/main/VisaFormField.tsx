          ...
          <form onSubmit={handleSubmit(handleVisaMainInit)}>
            <div className='w-full flex items-center h-auto divide-x divide-gray-300'>
              <div className='space-y-1'>
                ...
                />
                {visaMainForm.formState.errors.visa_type && (
                  <p className='text-red-500 text-sm mt-1 px-2'>{visaMainForm.formState.errors.visa_type.message}</p>
                )}
              </div>
              <div className='space-y-2'>
                <LocationDropDownField<TVisaMainFormSchema>
                  ...
                  locations={countries}
                />
                {visaMainForm.formState.errors.citizen_name && (
                  <p className='text-red-500 text-sm mt-1 px-2'>{visaMainForm.formState.errors.citizen_name.message}</p>
                )}
              </div>
              ...
              <div className='flex items-center justify-center gap-8'>
                <div className='space-y-2'>
                  <LocationDropDownField<TVisaMainFormSchema>
                    ...
                    locations={countries}
                  />
                  {visaMainForm.formState.errors.destination && (
                    <p className='text-red-500 text-sm mt-1 px-2'>
                      {visaMainForm.formState.errors.destination.message}
                    </p>
                  )}
                </div>
